    ...
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      {animationPhase === 'gift' && (
        <div ref={mainContentRef} className="relative z-10 flex flex-col items-center justify-center text-center text-white w-full h-full">
          ...
          <div className="flex flex-col items-center animate-fade-in-down">
            <h1 className="text-4xl md:text-6xl font-anime font-bold mb-8 text-yellow-300 drop-shadow-[0_0_10px_rgba(255,255,0,0.7)]">Incoming Transmission, {name}!</h1>
      ...
      {animationPhase === 'timerCountdown' && (
        <>
          ...
          <AnimeCharacterSVG
            expression="anxious"
            characterColor="#00FF00" // Neon Green
      ...
      {animationPhase === "finalMessage" && (
        <div className="relative z-10 flex flex-col items-center justify-center text-center text-white w-full h-full">
          <div ref={finalGiftRef} className="text-8xl text-purple-400 drop-shadow-[0_0_20px_rgba(255,0,255,0.8)]">🎁</div>
          ...
          <div className="mt-8 h-12 relative min-w-[240px]">
            <Button ref={revealButtonRef} onClick={handleReveal} className="absolute inset-0 bg-white/20 backdrop-blur-md border border-cyan-400 text-cyan-300 hover:bg-white/30 transition-all duration-300 font-anime drop-shadow-[0_0_8px_rgba(0,255,255,0.5)]">
              <Eye className="mr-2 h-4 w-4" /> Decrypt Message
            </Button>
            <Button ref={replayButtonRef} onClick={handleReplay} className="absolute inset-0 bg-white/20 backdrop-blur-md border border-purple-400 text-purple-300 hover:bg-white/30 transition-all duration-300 font-anime drop-shadow-[0_0_8px_rgba(255,0,255,0.5)]">
