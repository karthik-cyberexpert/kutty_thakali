...
const Surprise = () => {
  ...
  const birthdayMessage = customMessage || `Happy Birthday, ${name}! May your day be as bright and beautiful as your smile. Wishing you all the love and happiness in the world.`;
